  ...
  return (
    <View style={styles.container}>
      ...
      <Modal
        ...
        <View style={{marginLeft: 5}}>
          ...
          <Text style={{fontSize: 24, fontWeight: 'bold'}}>
            Silahkan pilih metode verifikasi yang Anda inginkan.
          </Text>
          <TouchableOpacity
            style={{flexDirection: 'row'}}
            onPress={e => sendOTPCode(e)}>
      ...
      <View style={styles.imgContainer}>
        <Image
          source={require('../../../../assets/danaku-logo.png')}
          style={styles.image}
        />
      </View>
      <View style={styles.headerTitle}>
        <Text style={styles.title}>DANAKU ID kamu sudah terdaftar:</Text>
        <Text style={styles.subtitle}>
          DANAKU ID Anda terhubung dengan nomor handphone kamu untuk proses
      ...
      <View style={styles.infoContainer}>
        ...
        <Text style={{color: '#7abae1'}}>
          DANAKU ID Anda hanya dapat diganti setiap 90 hari. Nomor yang
          sebelumnya telah Anda gunakan tidak dapat digunakan untuk ganti DANAKU
          Id dari nomor lain.
        </Text>
      </View>
      <TouchableOpacity
        style={isChange ? styles.changeButtonActive : styles.changeButton}
        onPress={e => modalPop(e)}>
