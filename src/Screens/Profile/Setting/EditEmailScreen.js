...
const emailDefault = 'danakuh@gmail.com';
...
const EditEmailScreen = props => {
  ...
  return (
    <View style={styles.container}>
      <View>
        <View style={styles.topHeader}>
          ...
          <Text style={styles.subtitleText}>
            Email kamu tidak akan dipublikasikan dan hanya digunakan untuk
            proses verifikasi akun DANAKU kamu
          </Text>
        </View>
        <Text
          style={{
        ...
        <View
          ...
          {isEmpty ? null : (
            <TouchableOpacity
              onPress={e => emptyEmail(e)}
              style={styles.cancel}>
              <Icon
                name="cancel"
                size={16}
                color={!isEdit || isEmailValid ? '#a0a0a0' : 'red'}
              />
            </TouchableOpacity>
          )}
        </View>
      ...
      <TouchableOpacity
        style={
          !isEdit && isEmailValid ? styles.button : styles.buttonDeactivate
        }
